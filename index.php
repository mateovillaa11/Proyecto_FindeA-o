        ...
        <ul id="slide-out" class="sidenav">
              <li>
                <div class="user-view">
                    <div class="background">
                      <img src="./Img/pexels-pixabay-269077.jpg">
                    </div>
                      <div>
                        <a href="index.php"><img class="circle" src="/documentacion/p"></a>
                        <a><span class="black-text name">Admin Empresa</span></a>
                        <a><span class="black-text email">AdminEmpresa1@gmail.com</span></a>
                      </div>
                    <li>
          ...
          <div id="modal2" class="modal">
            <div class="modal-content">
              <h4 class="center">Desea cerrar sesion</h4>
            </div>
